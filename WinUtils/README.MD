...
ODI.WCX - плагин для работы с простой посекторной копией дискет с файловой
...
*DI.WCX плагины могут работать с MBR-образами дисков (*.OHI) под
управлением плагина-обертки OHI.WCX, который для каждого типа партиций
