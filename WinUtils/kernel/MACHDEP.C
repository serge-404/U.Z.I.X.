...
/* GBL void panic(char* s, void* a1, void* a2, void* a3) */
GBL void panic(char* s, ...)
{
#ifdef BCB_COMPILER
        MessageBox(0, s, "PANIC:", MB_OK+MB_ICONSTOP);
#else
        va_list ap;
        va_start(ap, s);
	_di();
...
GBL void warning(char* s, ...)
/*	char *s;
	void *a1, *a2, *a3; */
{
#ifdef BCB_COMPILER
        MessageBox(0, s, "WARNING:", MB_OK+MB_ICONWARNING);
#else
   va_list ap;
   va_start(ap, s);
   kprintf("WARNING: ");
