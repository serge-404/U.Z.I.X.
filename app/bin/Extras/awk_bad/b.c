...
int qisalnum(int cc) { return isalnum(cc); }
int qisalpha(int cc) { return isalpha(cc); } 
#ifdef HAS_ISBLANK 
int qisblank(int cc) { return isblank(cc); } 
#endif
int qiscntrl(int cc) { return iscntrl(cc); } 
int qisdigit(int cc) { return isdigit(cc); } 
int qisgraph(int cc) { return isgraph(cc); } 
int qislower(int cc) { return islower(cc); } 
int qisprint(int cc) { return isprint(cc); } 
int qispunct(int cc) { return ispunct(cc); } 
int qisspace(int cc) { return isspace(cc); } 
int qisupper(int cc) { return isupper(cc); } 
int qisxdigit(int cc){ return isxdigit(cc); }
                                     
typedef int (* cc_fn)(int);

typedef struct s_charclass {
	const char *cc_name;
	int cc_namelen;
	cc_fn cc_func;
} t_charclass, *pcharclass;

t_charclass charclasses[] = {
	{ "alnum",	5,	qisalnum },
	{ "alpha",	5,	qisalpha },
#ifndef HAS_ISBLANK 
	{ "blank",	5,	qisspace }, /* was isblank */
#else
	{ "blank",	5,	qisblank },
#endif
	{ "cntrl",	5,	qiscntrl },
