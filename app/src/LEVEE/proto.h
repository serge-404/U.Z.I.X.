...
char  *PROC findbounds(register char  *ip);
...
int  PROC bchar(register int pos, int  npos);
int  PROC bigreplace(void);
int  PROC bseekeol(register int origin);
int  PROC cclass(register unsigned char  c);
...
int  PROC fchar(register int pos,int  npos);
int  PROC findDLE(register int  start,int  *endd,int  limit,int  dle);
...
int  PROC format(char  *out, register unsigned c);
int  PROC fseekeol(register int  origin);
...
int  PROC insertmacro(register char *cmdstr, int  count);
...
int  PROC moveright(char *src, char *dest, register int length);
int  PROC moveword(int  cp,int  forwd,int  toword);
int  PROC mvcur(register int y, int x);
int  PROC nextfile(int  prev);
int  PROC nextline(int  advance, register int  dest,int  count);
...
int  PROC printone(register int  i);
...
int  PROC putfile(FILE *f, register int start,int  endd);
...
int  PROC sentence(register int start, int  forwd);
int  PROC setX(int  cp);
int  PROC setY(int  cp);
int  PROC setcmd(void);
void PROC setend(void);
void PROC setpos(register int loc);
int  PROC settop(int  lines);
int  PROC skip(char *chars, register int cp, int  step);
int  PROC skipws(register int loc);
...
int  PROC tow(register int cp, int  step);
int  PROC undefine(register int  i);
int  PROC unmap(void);
